...
const faqs = [
  ...
  { q: "Is this affiliated with Amazon or any company’s assessment?", a: "No. CodeBreak doesn’t reproduce any company’s questions. It builds the same skill those tests screen for: reading unfamiliar code and fixing real bugs." },
...
export default function Home() {
  ...
  return <><SiteHeader/><main id="main-content" tabIndex={-1}>
    ...
    <section id="faq" className="faq page-width"><div><h2>Before you<br/>dive in.</h2><p>Six honest answers about how practice works here.</p></div><dl>{faqs.map((faq) => (<div key={faq.q}><dt>{faq.q}</dt><dd>{faq.a}</dd></div>))}</dl></section>
