...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    siteName: "BrokenRepo",
    title: "BrokenRepo — Code debugging practice on real repo bugs",
    ...
    url: "/",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "BrokenRepo — code debugging practice on real repo bugs" }],
  },
  twitter: {
