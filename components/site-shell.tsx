...
export function SiteFooter() {
  return <footer className="site-footer"><Link href="/" className="brand"><Code2 aria-hidden="true"/>BrokenRepo</Link><span>© {new Date().getFullYear()} BrokenRepo</span><nav aria-label="Footer navigation"><Link href="/challenges">Practice</Link><Link href="/contact">Contact support</Link></nav></footer>;
}
