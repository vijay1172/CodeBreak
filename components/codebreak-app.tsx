...
export function CodeBreakApp({ challengeId }: { challengeId: string }) {
  ...
  return <><SiteHeader/><main id="main-content" tabIndex={-1} className="lab">
    ...
    <div className="lab-grid">
      ...
      {result?.allPassed && challenge && <div className="debrief"><h3>What happened?</h3><p>{challenge.debrief.rootCause}</p><h3>Next time, watch for this</h3><p>{challenge.debrief.patternToWatch}</p><Link className="underlined" href="/progress">View your progress</Link></div>}
